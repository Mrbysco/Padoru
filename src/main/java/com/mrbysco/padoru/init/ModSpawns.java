...
public class ModSpawns {
	...
	public static void registerEntityAttributes(SpawnPlacementRegisterEvent event) {
		event.register(ModRegistry.PADORU.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Padoru::checkMobSpawnRules, SpawnPlacementRegisterEvent.Operation.AND);
	}
