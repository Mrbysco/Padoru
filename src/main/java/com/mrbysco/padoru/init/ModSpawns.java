...
public class ModSpawns {
    ...
    public static void entityAttributes() {
        EntitySpawnPlacementRegistry.register(ModRegistry.PADORU.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, PadoruEntity::checkMobSpawnRules);
    }
