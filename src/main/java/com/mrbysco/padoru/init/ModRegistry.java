...
public class ModRegistry {
    ...
    public static final RegistryObject<EntityType<PadoruEntity>> PADORU = ENTITIES.register("nero_claudius", () -> register("nero_claudius", EntityType.Builder.<PadoruEntity>of(PadoruEntity::new, EntityClassification.CREATURE).sized(0.5F, 1.0F)));
